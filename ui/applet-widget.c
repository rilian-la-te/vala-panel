...
G_DEFINE_TYPE_WITH_PRIVATE(ValaPanelApplet, vp_applet, GTK_TYPE_BIN)
...
static GObject *vp_applet_constructor(GType type, guint n_construct_properties,
                                              GObjectConstructParam *construct_properties)
{
	GObjectClass *parent_class = G_OBJECT_CLASS(vp_applet_parent_class);
	GObject *obj =
	    parent_class->constructor(type, n_construct_properties, construct_properties);
	ValaPanelApplet *self     = VALA_PANEL_APPLET(obj);
	ValaPanelAppletPrivate *p = vp_applet_get_instance_private(self);
                               ...
                               gpointer data)
{
	...
	vp_toplevel_configure_applet(vp_applet_get_toplevel(self),
	                                     vp_applet_get_uuid(self));
}
static void activate_remote(G_GNUC_UNUSED GSimpleAction *act, GVariant *param, gpointer obj)
{
	...
	vp_applet_remote_command(VALA_PANEL_APPLET(obj), command);
}
                           ...
                           gpointer obj)
{
	...
	vp_applet_info_show_about_dialog(pl_info);
}
                            ...
                            gpointer obj)
{
	...
	vp_layout_remove_applet(vp_toplevel_get_layout(p->toplevel), self);
}
static GtkWidget *vp_applet_get_config_dialog(G_GNUC_UNUSED ValaPanelApplet *self)
{
	return NULL;
}

static void vp_applet_measure(ValaPanelApplet *self, GtkOrientation orient, int for_size,
                                      int *min, int *nat, int *base_min, int *base_nat)
{
	...
	else
	{
		if (orient == GTK_ORIENTATION_HORIZONTAL)
			GTK_WIDGET_CLASS(vp_applet_parent_class)
...
static void vp_applet_get_preferred_height_for_width(GtkWidget *obj, int width, int *min,
                                                             int *nat)
{
	ValaPanelApplet *self = VALA_PANEL_APPLET(obj);
	int x, y;
	vp_applet_measure(self, GTK_ORIENTATION_VERTICAL, width, min, nat, &x, &y);
}
static void vp_applet_get_preferred_width_for_height(GtkWidget *obj, int height, int *min,
                                                             int *nat)
{
	ValaPanelApplet *self = VALA_PANEL_APPLET(obj);
	int x, y;
	vp_applet_measure(self, GTK_ORIENTATION_HORIZONTAL, height, min, nat, &x, &y);
}
static GtkSizeRequestMode vp_applet_get_request_mode(GtkWidget *obj)
{
	ValaPanelApplet *self     = VALA_PANEL_APPLET(obj);
	ValaPanelAppletPrivate *p = vp_applet_get_instance_private(VALA_PANEL_APPLET(self));
	GtkOrientation pos;
...
static void vp_applet_get_preferred_width(GtkWidget *obj, int *min, int *nat)
{
	ValaPanelApplet *self = VALA_PANEL_APPLET(obj);
	int x, y;
	vp_applet_measure(self, GTK_ORIENTATION_HORIZONTAL, 0, min, nat, &x, &y);
}
static void vp_applet_get_preferred_height(GtkWidget *obj, int *min, int *nat)
{
	ValaPanelApplet *self = VALA_PANEL_APPLET(obj);
	int x, y;
	vp_applet_measure(self, GTK_ORIENTATION_VERTICAL, 0, min, nat, &x, &y);
}

static void vp_applet_parent_set(GtkWidget *w, GtkWidget *prev_parent)
{
	...
	if (prev_parent == NULL)
	{
		...
		vp_applet_init_background(self);
	}
}
...
static void vp_applet_update_context_menu_private(G_GNUC_UNUSED ValaPanelApplet *self,
                                                          G_GNUC_UNUSED GMenu *parent_menu)
{
}

static void vp_applet_init(ValaPanelApplet *self)
{
	ValaPanelAppletPrivate *p = vp_applet_get_instance_private(self);
...
static void vp_applet_get_property(GObject *object, guint property_id, GValue *value,
                                           GParamSpec *pspec)
{
...
static void vp_applet_set_property(GObject *object, guint property_id, const GValue *value,
                                           GParamSpec *pspec)
{
...
static void vp_applet_finalize(GObject *obj)
{
	ValaPanelApplet *self     = VALA_PANEL_APPLET(obj);
	ValaPanelAppletPrivate *p = vp_applet_get_instance_private(VALA_PANEL_APPLET(self));
	...
	g_free0(p->uuid);
	G_OBJECT_CLASS(vp_applet_parent_class)->finalize(obj);
}
static void vp_applet_class_init(ValaPanelAppletClass *klass)
{
	VALA_PANEL_APPLET_CLASS(klass)->update_context_menu =
	    vp_applet_update_context_menu_private;
	VALA_PANEL_APPLET_CLASS(klass)->remote_command  = NULL;
	VALA_PANEL_APPLET_CLASS(klass)->get_settings_ui = vp_applet_get_config_dialog;
	GTK_WIDGET_CLASS(klass)->parent_set             = vp_applet_parent_set;
	GTK_WIDGET_CLASS(klass)->get_preferred_height_for_width =
	    vp_applet_get_preferred_height_for_width;
	GTK_WIDGET_CLASS(klass)->get_preferred_width_for_height =
	    vp_applet_get_preferred_width_for_height;
	GTK_WIDGET_CLASS(klass)->get_request_mode     = vp_applet_get_request_mode;
	GTK_WIDGET_CLASS(klass)->get_preferred_width  = vp_applet_get_preferred_width;
	GTK_WIDGET_CLASS(klass)->get_preferred_height = vp_applet_get_preferred_height;
	G_OBJECT_CLASS(klass)->constructor            = vp_applet_constructor;
	G_OBJECT_CLASS(klass)->get_property           = vp_applet_get_property;
	G_OBJECT_CLASS(klass)->set_property           = vp_applet_set_property;
	G_OBJECT_CLASS(klass)->finalize               = vp_applet_finalize;
