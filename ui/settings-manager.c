...
G_GNUC_INTERNAL ValaPanelCoreSettings *vala_panel_core_settings_new(const char *schema,
                                                                    const char *path,
...
G_GNUC_INTERNAL ValaPanelCoreSettings *vala_panel_core_settings_copy(
