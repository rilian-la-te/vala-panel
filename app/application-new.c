...
ValaPanelApplication* vala_panel_application_new()
{
    return (ValaPanelApplication*)g_object_new(vala_panel_application_get_type(),
                                               ...
                                               "resource-base-path", "/org/vala-panel/app", NULL);
}
...
static void vala_panel_application_startup (GApplication* base) {
    ...
    G_APPLICATION_CLASS (vala_panel_application_parent_class)->startup ((GApplication*) G_TYPE_CHECK_INSTANCE_CAST (self, gtk_application_get_type (), GtkApplication));
    ...
    g_action_map_add_action_entries ((GActionMap*) self, vala_panel_application_app_entries, G_N_ELEMENTS (vala_panel_application_app_entries), self);
...
//    G_OBJECT_CLASS (klass)->finalize = vala_panel_app_finalize;
        g_object_class_install_property(
          G_OBJECT_CLASS(klass), VALA_PANEL_APP_PROFILE,
          g_param_spec_string("profile", "profile", "profile", NULL,
                              G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK |
                                G_PARAM_STATIC_BLURB | G_PARAM_READABLE |
                                G_PARAM_WRITABLE));
        g_object_class_install_property(
          G_OBJECT_CLASS(klass), VALA_PANEL_APP_TERMINAL_COMMAND,
          g_param_spec_string(
            "terminal-command", "terminal-command", "terminal-command", NULL,
            G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB |
              G_PARAM_READABLE | G_PARAM_WRITABLE));
        g_object_class_install_property(
          G_OBJECT_CLASS(klass), VALA_PANEL_APP_LOGOUT_COMMAND,
          g_param_spec_string(
            "logout-command", "logout-command", "logout-command", NULL,
            G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB |
              G_PARAM_READABLE | G_PARAM_WRITABLE));
        g_object_class_install_property(
          G_OBJECT_CLASS(klass), VALA_PANEL_APP_SHUTDOWN_COMMAND,
          g_param_spec_string(
            "shutdown-command", "shutdown-command", "shutdown-command", NULL,
            G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB |
              G_PARAM_READABLE | G_PARAM_WRITABLE));
        g_object_class_install_property(
        ...
        g_object_class_install_property(
          ...
          g_param_spec_boolean("is-custom", "is-custom", "is-custom", FALSE,
                               G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK |
                                 ...
                                 G_PARAM_WRITABLE));
        g_object_class_install_property(
          G_OBJECT_CLASS(klass), VALA_PANEL_APP_CSS,
          g_param_spec_string("css", "css", "css", NULL,
                              G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK |
                                G_PARAM_STATIC_BLURB | G_PARAM_READABLE |
                                G_PARAM_WRITABLE));
}
