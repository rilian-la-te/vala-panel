...
static void
vala_panel_applet_info_bind_settings(ValaPanelAppletInfo* self)
{
  g_settings_bind(self->settings, "position", (GObject*)self, "position",
                  (G_SETTINGS_BIND_GET | G_SETTINGS_BIND_SET) |
                    G_SETTINGS_BIND_DEFAULT);
  g_settings_bind(self->settings, "alignment", (GObject*)self, "alignment",
                  (G_SETTINGS_BIND_GET | G_SETTINGS_BIND_SET) |
                    G_SETTINGS_BIND_DEFAULT);
  g_settings_bind(self->settings, "expand", (GObject*)self, "expand",
                  (G_SETTINGS_BIND_GET | G_SETTINGS_BIND_SET) |
                    G_SETTINGS_BIND_DEFAULT);
}

static void
vala_panel_applet_info_unbind_settings(ValaPanelAppletInfo* self)
{
...
{
  ValaPanelAppletInfo* self;
  self = G_TYPE_CHECK_INSTANCE_CAST(obj, vala_panel_applet_info_get_type(),
                                    ValaPanelAppletInfo);
...
vala_panel_applet_info_class_init(ValaPanelAppletInfoClass* klass)
{
  ...
  g_object_class_install_property(
    ...
    g_param_spec_object(
      "applet", "applet", "applet", vala_panel_applet_widget_get_type(),
  ...
  g_object_class_install_property(
    G_OBJECT_CLASS(klass), VALA_PANEL_APPLET_INFO_FILENAME,
  ...
  g_object_class_install_property(
    ...
    g_param_spec_enum("alignment", "alignment", "alignment", GTK_TYPE_ALIGN, 0,
                      G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK |
                        ...
                        G_PARAM_WRITABLE));
  g_object_class_install_property(
    G_OBJECT_CLASS(klass), VALA_PANEL_APPLET_INFO_ORIENTATION,
    g_param_spec_enum(
      "orientation", "orientation", "orientation", GTK_TYPE_ORIENTATION, 0,
      G_PARAM_STATIC_NAME | G_PARAM_STATIC_NICK | G_PARAM_STATIC_BLURB |
        G_PARAM_READABLE | G_PARAM_WRITABLE));
  g_object_class_install_property(
