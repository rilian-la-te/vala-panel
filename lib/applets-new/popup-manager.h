...
G_BEGIN_DECLS
G_DECLARE_INTERFACE(ValaPanelPopupManager,vala_panel_popup_manager,VALA_PANEL,POPUP_MANAGER,GObject);

struct _ValaPanelPopupManager
{
  GTypeInterface g_iface;
  void (*finalize) (ValaPanelPopupManager *self);
  void (*register_popover) (ValaPanelPopupManager* self, GtkWidget* widget, GtkPopover* popover);
  ...
  gboolean (*popover_is_registered) (ValaPanelPopupManager* self, GtkWidget* widget);
  gboolean (*menu_is_registered) (ValaPanelPopupManager* self, GtkWidget* widget);
};
G_END_DECLS
