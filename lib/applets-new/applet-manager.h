...
G_DECLARE_FINAL_TYPE(ValaPanelAppletManager,vala_panel_applet_manager,VALA_PANEL,APPLET_MANAGER,GObject)

char** vala_panel_applet_manager_get_available_types(ValaPanelAppletManager *self);
ValaPanelAppletInfo *vala_panel_applet_manager_get_applet_info_for_type(ValaPanelAppletManager *self,
