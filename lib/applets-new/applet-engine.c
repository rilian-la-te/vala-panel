...
ValaPanelAppletInfo *vala_panel_applet_engine_iface_get_applet_info_for_type(ValaPanelAppletEngineIface *self,
                                                                       const char *applet_type)
{
    if (self && g_slist_find(vala_panel_applet_engine_iface_get_available_types(self), applet_type))
...
ValaPanelAppletWidget *vala_panel_applet_engine_iface_get_applet_widget_for_type(
    ValaPanelAppletEngineIface *self, const char *applet_type, GSettings *settings, const char *uuid)
{
    if (self && g_slist_find(vala_panel_applet_engine_iface_get_available_types(self), applet_type))
        return VALA_PANEL_APPLET_ENGINE_IFACE_GET_IFACE(self)
...
bool vala_panel_applet_engine_iface_contains_applet(ValaPanelAppletEngineIface *self, const char *applet_type)
{
    return g_slist_find(vala_panel_applet_engine_iface_get_available_types(self), applet_type) !=
	       NULL;
}
