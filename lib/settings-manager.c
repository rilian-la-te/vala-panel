                                                    ...
                                                    bool is_toplevel)
{
	...
	created_settings->type_settings =
	    g_settings_new_with_backend_and_path(VALA_PANEL_CORE_SCHEMA, settings->backend, path);
                                                    ...
                                                    GSettingsBackend *backend)
{
	...
	new_settings->core_settings = g_settings_new_with_backend_and_path(VALA_PANEL_OBJECT_SCHEMA,
...
static ValaPanelUnitSettings *vala_panel_core_settings_add_unit_settings_internal(
...
{
	ValaPanelUnitSettings *usettings =
	    vala_panel_core_settings_add_unit_settings_internal(settings, name, uuid, is_toplevel);
...
bool vala_panel_core_settings_init_unit_list(ValaPanelCoreSettings *settings)
{
	...
	for (int i = 0; unit_list[i] != NULL; i++)
	{
		...
		vala_panel_core_settings_add_unit_settings_internal(settings,
		                                                    NULL,
		                                                    applet_uuid,
		                                                    false);
	}
