...
inline void css_apply_with_class (GtkWidget* widget, const gchar* css, const gchar *klass , gboolean remove);
...
inline gchar* css_apply_from_file (GtkWidget* widget, const gchar *file);
inline gchar* css_apply_from_resource (GtkWidget* widget, const char *file, const char* klass);
inline gchar* css_apply_from_file_to_app (const gchar *file);
