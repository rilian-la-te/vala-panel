...
struct _ValaPanelManagerInterface
{
    ...
    /*loading*/
    bool (*start_panels_from_profile)(ValaPanelManager* self, GtkApplication* app, const char* profile);
    /*struts*/
    ...
    void (*move_to_alloc)(ValaPanelManager* f, ValaPanelToplevelUnit* top, GtkAllocation* alloc);
    void (*move_to_side)(ValaPanelManager* f, ValaPanelToplevelUnit* top, GtkPositionType alloc);
    gpointer padding [12];
};
...
void vala_panel_manager_move_to_alloc(ValaPanelManager* f, ValaPanelToplevelUnit* top, GtkAllocation* alloc);
void vala_panel_manager_move_to_side(ValaPanelManager* f, ValaPanelToplevelUnit* top, GtkPositionType alloc);
