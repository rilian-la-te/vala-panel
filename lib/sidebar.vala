...
public class StackSidebar : Gtk.Bin
{
    ...
    private void set_new_stack(Gtk.Stack? stack) {
        if (this._stack != null) {
            disconnect_stack_signals();
            clear_sidebar();
        }
    ...
    void update_row(ref Gtk.ListBoxRow? row, Gtk.Widget? widget)
    {
        ...
        item.image.set_visible(icon != null);
    ...
    {
        SignalHandler.disconnect_by_func(_stack, (void*)on_stack_child_added, (void*)this);
        SignalHandler.disconnect_by_func(_stack, (void*)on_stack_child_removed, (void*)this);
        SignalHandler.disconnect_by_func(_stack, (void*)on_child_changed, (void*)this);
        SignalHandler.disconnect_by_func(_stack, (void*)disconnect_stack_signals, (void*)this);
    }
}
