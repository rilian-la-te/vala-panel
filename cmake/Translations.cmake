...
macro (add_translations_directory NLS_PACKAGE)
    ...
    configure_file (${CMAKE_CURRENT_SOURCE_DIR}/LINGUAS.in ${CMAKE_CURRENT_SOURCE_DIR}/LINGUAS)
	...
	foreach(PLUGIN_DESKTOP_IN_FILE ${SOURCE_FILES})
        get_filename_component( PLUGIN_FILE ${PLUGIN_DESKTOP_IN_FILE} NAME_WE )
        get_filename_component( BASE_DIRECTORY ${PLUGIN_DESKTOP_IN_FILE} PATH )
        add_custom_command (TARGET i18n COMMAND ${MSGFMT_EXECUTABLE} --desktop --keyword=Name --keyword=Description --keyword=Help -d ${CMAKE_CURRENT_SOURCE_DIR} --template ${CMAKE_SOURCE_DIR}/${PLUGIN_DESKTOP_IN_FILE} -o ${CMAKE_BINARY_DIR}/${BASE_DIRECTORY}/${PLUGIN_FILE}.plugin)
    endforeach()
    file (GLOB_RECURSE SOURCE_FILES RELATIVE ${CMAKE_SOURCE_DIR}/ ${CMAKE_SOURCE_DIR}/*.desktop.in)
    foreach(DESKTOP_IN_FILE ${SOURCE_FILES})
        get_filename_component( PLUGIN_FILE ${DESKTOP_IN_FILE} NAME_WE )
        get_filename_component( BASE_DIRECTORY ${DESKTOP_IN_FILE} PATH )
        add_custom_command (TARGET i18n COMMAND ${MSGFMT_EXECUTABLE} --desktop -d ${CMAKE_CURRENT_SOURCE_DIR} --template ${CMAKE_SOURCE_DIR}/${DESKTOP_IN_FILE} -o ${CMAKE_BINARY_DIR}/${BASE_DIRECTORY}/${PLUGIN_FILE}.desktop)
    endforeach()
...
macro (add_translations_catalog NLS_PACKAGE)
    ...
    foreach(FILES_INPUT ${ARGN})
        ...
        file (GLOB_RECURSE SOURCE_FILES RELATIVE ${CMAKE_CURRENT_SOURCE_DIR}/ ${BASE_DIRECTORY}/*.plugin.desktop.in)
        foreach(PLUGIN_DESKTOP_IN_FILE ${SOURCE_FILES})
